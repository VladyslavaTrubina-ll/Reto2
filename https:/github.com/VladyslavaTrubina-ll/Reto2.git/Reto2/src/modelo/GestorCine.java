...
public class GestorCine {
	...
	public  void registrarCliente() {
		...
		String dni = controladorEntrada.leerCadena();
		System.out.print("Escribe tu nombre: ");
		String nombre = controladorEntrada.leerCadena();
		System.out.print("Escribe tus apellidos: ");
		String apellidos = controladorEntrada.leerCadena();
		System.out.print("Escribe tu email: ");
		String email = controladorEntrada.leerCadena();
		System.out.print("Escribe tu contraseña: ");
		String contrasena = controladorEntrada.leerCadena();

		try {
			controlador.insertarUsuario(dni, nombre, apellidos, email, contrasena);
